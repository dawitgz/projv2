...
user1 = User(
        name='Dawit Bekele',
        email='dawit.g.bekele@gmail.com',
        picture='')
session.add(user1)
session.commit()
...
sportItem1 = SportItem(
                name="Shinguards",
                description="shinguard to protect the shins",
                category=category1,
                user=user1)
...
sportItem3 = SportItem(
                name="Jersey",
                description="Soccer team jersey",
                category=category1,
                user=user1)
...
sportItem5 = SportItem(
    ...
    backcountry, even park and pipe. They may be direectional \
    (meaning downlhill only) \
    ...
    all-mountain boards are good for beginners who are still learning what \
    terrain they like.",
    category=category2,
    user=user1)
...
sportItem6 = SportItem(
            name='Googles',
            description="Googles that protect eyes from the \
                    snowy glare.",
            category=category2,
            user=user2)
